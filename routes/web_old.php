    ...
    Route::group([
        ...
        Route::group([
            ...
            Route::group([
                ...
                Route::get('all', 'CuttingOrderController@outerList')->name('cutting.outer_list'); //yes
                Route::get('get-all-used', 'CuttingOrderController@getAllForUsed')->name('cutting.material.used_list'); //yes
                Route::get('get-all-hold', 'CuttingOrderController@getAllForHold')->name('cutting.material.hold_list'); //yes
                Route::get('get-inner_list', 'CuttingOrderController@getAllCounterInnerList')->name('cutting.material.counter_inner_list'); //yes
                Route::get('get-factory-list', 'CuttingOrderController@companyList')->name('cutting.factory_list'); //yes
            ...
            Route::group([
                ...
                Route::get('show/{id}', 'ProduceOrderController@show')->name('produce_order.show')->middleware('can:show-produceorder');
            ...
            Route::group([
                ...
                Route::post('checkIfExists', 'ReceivingDamagedOrdersController@checkIfExists')->name('receiving.damaged_product.checkIfExists')->middleware('can:add-receivingordersfix');
                //
            });
            ...
            Route::group([
                ...
                Route::get('edit/{id}', 'SendEndProductController@edit')->name('send.end_product.edit_page')->middleware('can:edit-sendorders');
