...
<div class="row">
    <div class="col-md-12">
        <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form role="form" id = "myForm" action="{{Route('factory.update')}}" method="POST">
                @csrf
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="name" value="{{$data['factory']->name}}" id="name"
                            ...
                            @enderror
                        <input type="hidden" name="factory_id" value="{{$data['factory']->id}}">
                    </div>
                    <div class="row ">
                        <div class="col-md-4">
                            <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <div class="form-group ">
                            <label for="factory_type_id">نوع المصنع</label>
                            <select class="form-control" name="factory_type_id" id="factory_type_id"  class="@error('factory_type_id') is-danger @enderror">
