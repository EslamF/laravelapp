...
<div id = "content_here" style = "" >
    ...
    <div style="page-break-after: always;margin:0;" class = "page">
        ...
        <div style = "">
            ...
            {!! DNS1D::getBarcodeSVG($product->prod_code, 'EAN13',2.1,60,'black', true) !!}
        ...
        <span class = "" style = "margin-right:50px;font-size:0.5pt;">M.O.M Brand</span>
