                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control" name="password_confirmation"
                                id="exampleInputPassword1" placeholder="تأكيد كلمه المرور">
                            @error('password_confirmation')
                            <p class="help is-danger">
                                {{ $message }}
                            </p>
                        ...
                        <div class="form-group ">
                            ...
                            <select class="form-control" name="role_id" id="role_id">
                                <option value="" disabled selected class="@error('role_id') is-danger @enderror"
                                    value="{{ old('role_id') }}">اختر نوع الوظيفة </option>
