...
<div id="app" class="row">
    <div class="col-md-4">
        <div class="form-group">
            ...
            <multiselect v-model="value" :options="options" :multiple="true" :close-on-select="false" :clear-on-select="false" :preserve-search="true" placeholder="Choose Orders" label="bar_code" track-by="id" :preselect-first="true"></multiselect>
        </div>
    </div>
    <div class="col-md-4">
        <div class="form-group">
